...
// 2. กําหนดชองทาง (Port) ที่เซิรฟเวอรจะใชสื่อสาร โดยใหใชของที่ Cloud กําหนดมา(process.env.PORT) ถาไมมีใหใช 3000
 ...
 // 3. สร้างเครื่องแม่ขาย (Server) ที่คอยรับคําขอ (req) และตอบกลับ (res)
...
res.end('<h1>สวัสดีครับ! นี่คือ Web Server ของ [นรากร สวนนาค 69319011700] </h1><p>เครื่องแมขายทํางานปกติบนระบบ Railway แลวครับผม!</p>');
 });
